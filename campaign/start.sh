...
LAUNCH_CMD+="; echo ''"
LAUNCH_CMD+="; echo -e '\033[0;32m[*] Running post-campaign analysis...\033[0m'"
LAUNCH_CMD+="; ./campaign/analyse.sh ${CAMPAIGN_NAME}"
LAUNCH_CMD+="; echo '${CAMPAIGN_NAME}' > ${PROJECT_ROOT}/results/.last-campaign"
LAUNCH_CMD+="; echo ''"
LAUNCH_CMD+="; echo '[done] Analysis complete. Press Enter to close.'"
LAUNCH_CMD+="; read"
LAUNCH_CMD+="; tmux kill-session -t \"${SESSION}\""
