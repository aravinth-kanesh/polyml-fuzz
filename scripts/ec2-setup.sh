...
echo -e "  If running via setup.sh (recommended), it will continue automatically."
echo -e "  To complete setup manually:"
echo ""
echo -e "  1. ${BLUE}Build Poly/ML:${NC}      ./scripts/build-polyml.sh"
echo -e "  2. ${BLUE}Verify setup:${NC}       ./scripts/verify-build.sh"
echo -e "  3. ${BLUE}Validate seeds:${NC}     ./scripts/validate-seeds.sh"
echo -e "  4. ${BLUE}Launch campaign:${NC}    ./fuzz.sh"
